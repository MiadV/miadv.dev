            ...
            <div>
              <section id="about-me">
                ...
                <p className="pt-6 text-base">
                  ...
                  applications using modern web development tools and
                  continuously learning and exploring new technologies to stay
                  up-to-date with the latest industry trends. Throughout my
                  career, I have experienced working on a variety of projects,
                  including eCommerce, static websites, and full-stack web
                  applications and I am always excited to take on new
                  challenges.
                </p>
              </section>
                    ...
                    <div className="mt-6 text-sm">
                      <ul>
                        ...
                        <li>
                          ...
                          developers, resulting in improved team productivity
                        ...
                        <li>
                          ...
                          lazy loading and code splitting to improve website
                          load times and increase user retention.
                        </li>
                        <li>
                          Developed and currently maintain multiple frontend
                          repositories, ensuring the scalability and
