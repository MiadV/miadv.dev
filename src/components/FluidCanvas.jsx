...
`
    ...
    return () => {
      gl.clear();
      canvas.removeEventListener('mouseover', mouseOverListener);
  ...
  return (
    <canvas id="fluid_canvas" className={className} ref={canvasRef}></canvas>
  );
};
