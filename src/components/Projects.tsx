...
export const Projects = () => {
  return (
    <section id="projects" className="relative py-16">
      <span className="absolute inset-2/4 -z-10 h-[500px] w-[500px] -translate-y-1/2  -translate-x-1/2 rounded-full bg-gradient-radial from-indigo-500/40 via-fuchsia-400/20 blur-2xl" />
